...
from taiyi_piper_x_collect.teleop_processes import TeleopProcess, list_teleop_processes, terminate_teleop_processes
...
def test_terminate_teleop_processes_prefers_sigint() -> None:
    process = TeleopProcess(pid=101, command="pika_remote_agx_arm teleop_single_piper_x.launch.py")
    calls = 0
